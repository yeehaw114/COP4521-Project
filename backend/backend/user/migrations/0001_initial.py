    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(related_name='role_permissions', to='auth.permission', verbose_name='Permissions for this Role')),
        ...
        migrations.AddField(
            model_name='user',
            name='roles',
            field=models.ManyToManyField(related_name='role_users', to='user.role'),
        ),
    ]
